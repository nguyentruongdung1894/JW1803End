            ...
            <div class="main-content">
                <div class="main-content-inner">
                    ...
                    <div class="page-content">
                        ...
                        <div class="row">
                            <div class="col-xs-12">
                                <f:form action="update-ship.htm" modelAttribute="ship" method="POST">
                                    <table>
                                        <tr>
                                            <td>idShip</td>
                                            <td><f:input path="idShip"/></td>
                                        </tr>
                                        <tr>
                                            <td>nameShip</td>
                                            <td><f:input path="nameShip"/></td>
                                        </tr>
                                        <tr>
                                            <td>phone</td>
