                                        ...
                                        <tbody id="id01">
                                            <c:forEach items="${listFadmin}" var="F">
                                                <tr>
                                                    ...
                                                    <td>${F.categoryId}</td>
                                                    <td>${F.productName}</td>
                                                    <td><img src="${F.productImage}" alt="${F.productName}"></td>
                                                    <td>${F.date}</td>
                                                    <td>${F.quantity}</td>
                                                    <td>${F.description}</td>
                                                    <td>${F.price}</td>
                                                    ...
                                                    <td>
                                                        <div class="hidden-sm hidden-xs action-buttons">
                                                            ...
                                                            <a class="green" href="iUpdate.htm?productId=${F.productId}">
                                                                <i class="ace-icon fa fa-pencil bigger-130"></i>
                                                            </a>

                                                            <a class="red" href="delete-product.htm?productId=${F.productId}">
